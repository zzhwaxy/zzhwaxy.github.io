...
live2d_settings['waifuTipsSize']        = '300x84';     // 提示框大小，例如 '250x70', '570x150'
live2d_settings['waifuFontSize']        = '15px';       // 提示框字体，例如 '12px', '30px'
live2d_settings['waifuToolFont']        = '15px';       // 工具栏字体，例如 '14px', '36px'
...
live2d_settings['aboutPageUrl']         = 'https://github.com/zzhwaxy';   // 关于页地址, '{URL 网址}'
